...
<body>
	...
	<main>
		...
		<div align="center">
			...
			<p style='font-size:30px'><b>Assigned Subjects List </b></p>
			<table id="subjects">
				<thead>
					<tr>
					<th>Subject Id</th>
				...
				<tbody>
					<%
						try{
							...
							Query query = s.createQuery("from SubjectClass");
							List<SubjectClass> sbc = query.list();
							for(SubjectClass sb:sbc){
								out.println("<tr><td>"+sb.getSubid()+"</td><td>"+sb.getSubjectname()+"</td><td>"+sb.getSubcode()+"</td><td>"+sb.getClasses()+"</td></tr>");
							}
							tx.commit();
							s.close();
						}catch(Exception e){
	...
	<div class="footer">
		<p>Learner's Academy.All Rights Reserved.</p>
	</div>
